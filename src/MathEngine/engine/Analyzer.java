...
public class Analyzer {
    ...
    private static Pattern patternEmptyBracket = Pattern.compile("\\(\\)");
    ...
    public boolean analyze(String expression) {
        ...
        return numBranch == 0 && !patternUnaryOperation.matcher(expression).find() && !patternEmptyBracket.matcher(expression).find();
    }
